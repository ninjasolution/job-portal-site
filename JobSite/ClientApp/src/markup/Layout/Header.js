			...
			<Navbar>
				<Container>
					...
					<Navbar.Collapse className="justify-content-end">
						<Navbar.Text>
							{
								authedUser ? <h6>Hello, {authedUser.userName ? authedUser.userName : authedUser.name}</h6> :
						...
						<div className="container clearfix">
							...
							<div className="extra-nav">
								<div className="extra-cell">
									<Link to={"/Authenticate"} className="site-button"><i className="fa fa-user"></i> Sign Up</Link>
										...
										<ul className="sub-menu">
											...
											<li><Link to={'#'} className="dez-page">register <i className="fa fa-angle-right"></i></Link>
												<ul className="sub-menu">
													...
													<li><Link to={"/Authenticate"} className="dez-page">register 2 <span className="new-page">New</span></Link></li>
												</ul>
											</li>
